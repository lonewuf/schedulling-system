...
$('.tooth-11').mouseover(function(){
  $('.tooth-11-parent').css('fill', 'red');
  $('.tooth-11-parent').css('cursor', 'pointer');
});
...
// $('#t-12').mouseover(function(){
//   $('.tooth-12-parent').css('fill', 'red');
//   $('.tooth-12-parent').css('cursor', 'pointer');
// });
